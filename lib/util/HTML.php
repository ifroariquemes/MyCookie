...
namespace MyCookie\Lib\Util;

// <editor-fold defaultstate="collapsed" desc="Definição das Constantes">
...
define('CAMPO_CHECK', 'checkbox');
define('CAMPO_COMBO', 'select');
define('CAMPO_RADIO', 'radio');
define('CAMPO_SENHA', 'password');
define('CAMPO_TEXTO', 'text');
define('CAMPO_TEXTOGRANDE', 'textarea');
// </editor-fold>

require_once('html/tag.class.php');
require_once('html/form.class.php');
require_once('html/input.class.php');
require_once('html/select.class.php');
require_once('html/textarea.class.php');

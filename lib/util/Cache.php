...
class Cache {
    ...
    public static function getInstance() {
        if (!isset(self::$instance)) {
            // Factory method
            switch (CACHE_TYPE) {
                case 'apc': self::$cache = new APC_Cache;
                    break;
                case 'eaccelerator': self::$cache = new eAccelerator_Cache;
                    break;
                case 'xcache': self::$cache = new XCache_Cache;
                    break;
                case 'file': self::$cache = new File_Cache;
                    break;
    ...
    public function setVar($VarName, $VarValue, $TimeLimt = Cache::CACHE_FIVE_MINUTES) {
        return self::$cache->setVar($VarName, $VarValue, $TimeLimt);
    }

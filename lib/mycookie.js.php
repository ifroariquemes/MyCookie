...
<script type="text/javascript">
  ...
  function TMyCookieJS() {
    ...
    this.getAcao = function() {
      return '<?php echo $_MyCookie->getAction(); ?>';
    }
    ...
    this.getModulo = function() {
      return '<?php echo $_MyCookie->getModule(); ?>';
    }
    ...
    this.getModuloAuxiliar = function() {
      return '<?php echo $_MyCookie->getAuxiliarModule(); ?>';
    }
    ...
    this.getNamespace = function() {
      return '<?php echo str_replace('\\', '\\\\', $_MyCookie->getNamespace()); ?>';
    }
    ...
    this.getSite = function() {
      return '<?php echo $_MyCookie->getSite(); ?>';
    }
